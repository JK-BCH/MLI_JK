...
imwrite(fusedImage,fullfile(Outdir, [formattedTime '_MLI_' filename]));
imwrite(binaryImage,fullfile(Outdir, [formattedTime '_Binary_' filename]));
imwrite(outputImage,fullfile(Outdir, [formattedTime '_Lines_' filename]));
%% % Area calculation
